<template>
  <v-card style="padding: 16px;margin-bottom: 15px;" class="d-flex">
    ...
    <div v-if="commentData.status === 0" class="flex-grow-1 overflow-auto" style="border-radius: 0px;">
    ...
    <div v-if="commentData.status === 1" class="flex-grow-1 overflow-auto" style="border-radius: 0px;">
